...
var actionTab = actionTable{
	...
	actionRow{ // S159
		...
		actions: [numSymbols]action{
			...
			nil,        // cte_int
			nil,        // cte_float
			reduce(61), // print, reduce: F_Call
			nil,        // cte_string
			reduce(61), // while, reduce: F_Call
			nil,        // do
			reduce(61), // if, reduce: F_Call
			nil,        // else
		},
	},
	actionRow{ // S160
